...
-- 表：t_user
CREATE TABLE t_user (id INTEGER PRIMARY KEY NOT NULL DEFAULT NULL, uid BIGINT UNIQUE NOT NULL DEFAULT NULL, password VARCHAR (64) DEFAULT NULL, balance BIGINT CONSTRAINT 'NULL' DEFAULT NULL, createDate CHAR (8) DEFAULT NULL, createTime CHAR (8) DEFAULT (NULL), modifyDate CHAR (8) DEFAULT NULL, modifyTime CHAR (8) DEFAULT NULL);
